...
export const STAMMDATEN_GROUPS: ProfileFieldGroup[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: "kinderNamen",
        label: "Namen der Kinder",
        type: "text",
        fullWidth: true,
        placeholder: "z. B. Emma (2019), Paul (2022)",
        description: "Mit Geburtsjahr, durch Komma getrennt — erscheint so in der Selbstauskunft.",
      },
    ],
  },
  {
...
export const HAUSHALT_GROUPS: ProfileFieldGroup[] = [
  ...
  },
  {
    ...
    fields: [
      {
        key: "fwZweck",
        label: "Geplantes Vorhaben",
        type: "select",
        fullWidth: true,
        options: [
          { value: "kauf", label: "Kauf" },
          { value: "neubau", label: "Neubau" },
          { value: "anschlussfinanzierung", label: "Anschlussfinanzierung" },
          { value: "kapitalbeschaffung", label: "Kapitalbeschaffung" },
        ],
      },
      {
        key: "fwNutzung",
      ...
      {
        key: "fwRegion",
        label: "Gewünschte Region",
        type: "text",
        placeholder: "z. B. Berlin / Umland",
      },
      {
        key: "fwKaufpreis",
        label: "Ziel-Kaufpreis (Spanne)",
        type: "text",
        placeholder: "z. B. 200.000–300.000 €",
        description: "So sieht die Bank sofort, in welcher Größenordnung du suchst.",
      },
      {
        key: "fwDarlehen",
        label: "Gewünschtes Darlehen",
        type: "number",
        suffix: "€",
        description: "Ungefähres Fremdkapital für den nächsten Kauf.",
      },
      {
        key: "fwZinsbindung",
        label: "Gewünschte Zinsbindung",
        type: "number",
        suffix: "Jahre",
        presets: [10, 15, 20],
      },
