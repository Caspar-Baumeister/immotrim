...
export const HAUSHALT_GROUPS: ProfileFieldGroup[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "lebenshaltung", label: "Lebenshaltung", type: "number", suffix: "€", description: "Essen, Mobilität, Freizeit — grober Richtwert genügt.", info: "Alle privaten Lebenshaltungskosten: Essen, Kleidung, Mobilität, Freizeit, Kommunikation. Ein realistischer Richtwert genügt — die Bank rechnet ohnehin mit eigenen Pauschalen gegen." },
      { key: "krankenversicherung", label: "Krankenversicherung", type: "number", suffix: "€", info: "Nur eintragen, wenn du den Beitrag selbst zahlst — also privat versichert oder freiwillig gesetzlich. Bei Angestellten in der gesetzlichen Kasse ist der Beitrag schon vom Netto abgezogen; dann hier leer lassen." },
      { key: "versicherungen", label: "Weitere Versicherungen", type: "number", suffix: "€", info: "Monatssumme sonstiger Policen: Haftpflicht, Hausrat, Berufsunfähigkeit, Lebens-/Rentenversicherung, Kfz. Die Krankenversicherung NICHT doppelt zählen." },
      ...
      { key: "sonstigeAusgaben", label: "Sonstige Ausgaben", type: "number", suffix: "€", info: "Regelmäßige Ausgaben, die oben nicht passen: z. B. Unterhaltszahlungen, Sparpläne, Abos oder Vereinsbeiträge." },
    ],
  },
  {
    title: "Vermögen",
