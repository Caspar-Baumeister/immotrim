...
export default async function SharePage({ params }: Props) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      <PublicShareHeader locale={locale} />
      ...
      <main className="flex-1 w-full mx-auto max-w-7xl p-4 sm:p-6 flex flex-col gap-6">
        ...
        <div className="rounded-xl border border-amber-500/30 bg-amber-500/10 p-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
          <div>
