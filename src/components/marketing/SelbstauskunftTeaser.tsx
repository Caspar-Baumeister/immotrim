...
export async function SelbstauskunftTeaser() {
        ...
        <div className="space-y-5">
          ...
          <div className="flex flex-col gap-3 pt-1 sm:flex-row sm:items-center">
            ...
            <a
              ...
              download
              className="inline-flex w-fit items-center justify-center gap-2 text-sm font-semibold text-[#6c5ce7] bg-[#6c5ce7]/10 hover:bg-[#6c5ce7]/20 border border-[#6c5ce7]/20 rounded-lg px-4 py-2.5 transition-colors"
            >
          ...
          <div className="flex items-center justify-between gap-3 sm:gap-5">
            ...
            <div className="relative h-px flex-1 bg-border">
              {[0, 1, 2].map((i) => (
                <span
                  key={i}
                  className="absolute top-1/2 left-0 h-1.5 w-1.5 -translate-y-1/2 rounded-full bg-[#6c5ce7] [animation:immotrim-flow-dot_2.4s_linear_infinite]"
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="flex h-14 w-14 items-center justify-center rounded-xl border border-[#6c5ce7]/30 bg-[#6c5ce7]/10">
                <Sparkles className="h-6 w-6 text-[#6c5ce7] [animation:immotrim-float_2.5s_ease-in-out_infinite]" />
              </div>
              <div className="h-1.5 w-14 overflow-hidden rounded-full bg-foreground/10">
                <div className="h-full rounded-full bg-[#6c5ce7] [animation:immotrim-progress_4s_ease-in-out_infinite]" />
              </div>
            </div>
